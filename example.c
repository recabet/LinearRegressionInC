...
int main(int argc, char** argv)
{
    ...
    const float initial_coefficient = randf() * 10;
    const float initial_bias = randf() * 10;

    /* Example data */
    const float example_data[][2] = {
        {0, 0},
        {1, 2.3},
        {2, 4.2},
        {3, 7.3},
    ...
    /* Train the model */
    float* result = fit(initial_coefficient, initial_bias, 1e-2, 1e-2, 5000);
